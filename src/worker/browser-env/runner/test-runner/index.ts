...
import type { Selector, ChainablePromiseElement } from "webdriverio";
        ...
        return [
            async (): Promise<void> => {
                ...
                this._socket.emit(WorkerEventNames.initialize, {
                    ...
                    requestedCapabilities: (this._runOpts.sessionOpts as {capabilities: WebdriverIO.Browser["capabilities"]}).capabilities,
